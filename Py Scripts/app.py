...
def create_connection():
    ...
    password = pwd.get()
    try:
        connection = cx_Oracle.connect(user=app.username, password=app.password, dsn="(DESCRIPTION=(ADDRESS=(PROTOCOL=TCP)(Host=oracle.scs.ryerson.ca)(Port=1521))(CONNECT_DATA=(SID=orcl)))")
